...
import uk.ac.qub.jmccambridge06.wetravel.ui.Itinerary.ActivityDetailsFragment;

/**
 * Holds controller logic for an activity list
 */
public class ActivityListAdapter extends EntryListAdapter {

    /**
     * Holds controller logic for an activities view holder
     */
    public static class ActivityListViewHolder extends EntryListViewHolder {

        /**
         * Constructs an activities view holder
         * @param itemView
         */
